...
void fpga_driver::fpga_chip_select() { GPIO_ResetBits(FPGA_GPIO_PORT, FPGA_GPIO_NSS_PIN); }

void fpga_driver::fpga_chip_deselect() { GPIO_SetBits(FPGA_GPIO_PORT, FPGA_GPIO_NSS_PIN); }
