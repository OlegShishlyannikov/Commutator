...
void spi_flash_driver::spi_flash_wp_enable()
{
  GPIO_ResetBits( SPI_FLASH_WP_HOLD_PORT, SPI_FLASH_WP_HOLD_GPIO_WP_PIN );
}

void spi_flash_driver::spi_flash_wp_disable()
{
  GPIO_SetBits( SPI_FLASH_WP_HOLD_PORT, SPI_FLASH_WP_HOLD_GPIO_WP_PIN );
}

void spi_flash_driver::spi_flash_chip_select()
{
  GPIO_ResetBits( SPI_FLASH_GPIO_PORT, SPI_FLASH_GPIO_NSS_PIN );
}

void spi_flash_driver::spi_flash_chip_deselect()
{
  GPIO_SetBits( SPI_FLASH_GPIO_PORT, SPI_FLASH_GPIO_NSS_PIN );
}
...
uint8_t spi_flash_driver::spi_flash_read_byte()
{
  return ( spi_flash_driver::spi_flash_send_byte( W25X_DUMMY_BYTE ));
}
