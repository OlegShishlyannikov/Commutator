...
pc_usart_driver::pc_usart_driver() { asm("nop"); }
...
const char pc_usart_driver::read_char() { return USART_ReceiveData(PC_USART_PORT); }
pc_usart_driver::~pc_usart_driver() { USART_DeInit(PC_USART_PORT); }
